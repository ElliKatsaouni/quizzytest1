"""quizzy_project URL Configuration
...
urlpatterns = [
    ...
    url(r'^quizzy/', include('quizzy.urls')),
    ...
    # url(r'^accounts/password/change/done/$', MyRegistrationView.as_view(), name='change_password_done'),
